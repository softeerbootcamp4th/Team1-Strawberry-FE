...
// 사용 방법
// const Display1Medium = styled.h1`
//     ${Typography.Display1Medium}
// `;
...
const createTypographyStyle = (fontSizeKey: keyof typeof fontSize, fontWeight: keyof typeof weight, lineHeightKey: keyof typeof lineHeight) => css`
